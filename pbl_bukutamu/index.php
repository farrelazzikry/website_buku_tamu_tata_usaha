...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light sticky-top">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center" href="#">
        <img src="assets/images/logo-baru.png" alt="Polibatam" class="me-2" />
        <div>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item ms-2"><a href="checkout_manual.php" class="btn btn-checkout-nav fw-semibold">Checkout
            Ulang</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card card-custom p-4" style="max-width: 500px; width: 100%;">
      ...
      <div id="deteksiStatus" class="alert alert-info py-2 px-3 mb-3 d-none"
  ...
  <footer>
    <div class="container">
      <div class="logo-section">
        <img src="assets/images/logo-baru.png" alt="Polibatam Logo" />
